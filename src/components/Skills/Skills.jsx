...
const DECK = [
  {
    ...
    foot: 'Shipped at PwC · Goldman Sachs · Thoughtworks',
    skills: [
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      cards.forEach((card, i) => {
        ...
        const els = card.querySelectorAll('.skd-card-head > *, .skd-row, .skd-card-foot')
        ...
        if (i < cards.length - 1) {
          ...
          gsap.timeline({
            ...
            .fromTo(card, { scale: 1 }, { scale: 0.94, transformOrigin: 'center top' }, 0)
          ...
          {DECK.map((card, i) => (
            ...
            >
              ...
              <div className="skd-card-head">
                <div className="skd-card-kicker-row">
                  <span className="skd-card-kicker">Discipline {card.num} / 03</span>
